...
public class EmpleadoDB {
    ...
    public LinkedList<Empleado> ObtenerEmpleadosPorJornada(String Jornada) throws SNMPExceptions, SQLException{
        String select= "";
        ...
        try{
            ...
            select=
                    ...
                    "      ,[jornada]\n" +
                    "      ,[activo]\n" +
                    "  FROM [ProyectoG5].[dbo].[Empleado] WHERE [jornada] = '" + Jornada + "';";
            //se ejecuta la sentencia sql
            ResultSet rsPA= accesoDatos.ejecutaSQLRetornaRS(select);
            //se llama el array con los Empleados
            while(rsPA.next()){
